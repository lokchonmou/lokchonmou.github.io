...
<img src="/media/game-coding/Spacewar/1024px-Spacewar!-PDP-1-20070512.jpg" alt="Spacewar on a round monitor on a desk" style="zoom:66%;" />
...
<img src="/media/game-coding/Spacewar/GPB_circling_earth.jpg" alt="img" style="zoom:50%;" />

如果兩個質點的質量分別為$m_1$和$m_2$，並且它們之間的距離為$r$，則它們之間的引力$F$為:
$$
F = \frac{Gm_1m_2}{r^2}\hat{r}
$$
<div style="text-align: center"><img src="/media/game-coding/Spacewar/ch02_06.png" alt="Nature of Code Image" style="width:45%;" /><img src="/media/game-coding/Spacewar/ch02_08.png" alt="Nature of Code Image" style="width:45%;" /></div>
...
![star1](/media/game-coding/Spacewar/star1.gif)
...
![star2](/media/game-coding/Spacewar/star2.gif)
...
<img src="/media/game-coding/Spacewar/star3.gif" alt="star3" style="width:33%;" /><img src="/media/game-coding/Spacewar/star4.gif" alt="star4" style="width:33%;" />
    <br>
<img src="/media/game-coding/Spacewar/star5.gif" alt="star5" style="width:33%;" /><img src="/media/game-coding/Spacewar/star6.gif" alt="star6" style="width:33%;" />
</div>

上面這四張圖，`star1.vec`的初始值分別是 `PVector(4, 0)`, ` PVector(5, 0)`,  `PVector(7, 0)`,  `PVector(8, 0)`，大於8的話，中間的`star2`便不能夠吸引`star1`圍繞著轉。

<img src="/media/game-coding/Spacewar/star7.gif" alt="star7" style="zoom:80%;" />
...
![Star wars rebels | The power of the sun … in the palm of my hand...](/media/game-coding/Spacewar/tumblr_piyau4VbBJ1rk9c31o1_540.gif)
