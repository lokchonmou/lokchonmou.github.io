...
<img src="/media/game-coding/Pacman/image-20230518102159875.png" alt="image-20230518102159875" style="zoom:67%;" />
...
<img src="/media/game-coding/Pacman/image-20230518103332453.png" alt="image-20230518103332453" style="zoom: 67%;" />
...
接著在`setup()`的最後，開始演算法前第一步是將`start`放入`openSet`和計定`start`的`gCost`為`0`。

> 一般路徑演算法都是剛好相反，由終點找回起點；為方便解說和理解，這裡改為由起點找到終點。理論上亦會一併計算`hCost`和`fCost`，但不計算也不會影響結果。
...
<img src="/media/game-coding/Pacman/image-20230518111208045.png" alt="image-20230518111208045" style="zoom:67%;" />
...
<img src="/media/game-coding/Pacman/image-20230518113239435.png" alt="image-20230518113239435" style="zoom:67%;" />
...
<img src="/media/game-coding/Pacman/AStar1.gif" alt="AStar1" style="zoom:67%;" />
