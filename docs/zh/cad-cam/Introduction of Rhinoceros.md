...
1. Find the icon of Rhinoceros 5 (64-bit) OR Rhinoceros 4.
   ...
   ![image-20220519132656568](/media/Introduction of Rhinoceros/image-20220519132656568.png)
...
2. When you open Rhinoceros, choose a template, you can choose:
   ...
   <img src="/media/Introduction of Rhinoceros/image-20220519132827730.png" alt="image-20220519132827730" style="zoom:67%;" />
...
<img src="/media/Introduction of Rhinoceros/image-20220519133002088.png" alt="image-20220519133002088" style="zoom:67%;" />
...
![image-20220519133416953](/media/Introduction of Rhinoceros/image-20220519133416953.png)
...
![image-20220519133634811](/media/Introduction of Rhinoceros/image-20220519133634811.png)

- `Osnap `stand for  "Object Snap", which can snap(鎖定)the special point in the geometry

<img src="/media/Introduction of Rhinoceros/image-20220519134602634.png" alt="image-20220519134602634" style="zoom:50%;" />

## Start to draw

1. Only focus on the TOP view, ==DOUBLE CLICK== the `TOP `icon
1. Hold **mouse right click** to drag the view

<img src="/media/Introduction of Rhinoceros/1.gif" alt="1" style="width:45%;" /><img src="/media/Introduction of Rhinoceros/drag.gif" alt="drag" style="width:45%;" />
...
<img src="/media/Introduction of Rhinoceros/line.gif" alt="line" style="width:45%;" />
...
<img src="/media/Introduction of Rhinoceros/line2.gif" alt="line2" style="width:45%;" />
...
<img src="/media/Introduction of Rhinoceros/line3.gif" alt="line3" style="width:45%;" />

#### `Polyline`

If you want to draw a few continues line segment, you can use command `polyline`

<img src="/media/Introduction of Rhinoceros/polyline.gif" alt="polyline" style="width:45%;" />
...
<img src="/media/Introduction of Rhinoceros/rect.gif" alt="rect" style="width:45%;" />
...
<img src="/media/Introduction of Rhinoceros/rect_3p.gif" alt="rect_3p" style="width:45%;" />

#### Center mode

Or you can use center method, define the center point of the rectangle, then define the corner

<img src="/media/Introduction of Rhinoceros/rect_cen.gif" alt="rect_cen" style="width:45%;" />
...
<img src="/media/Introduction of Rhinoceros/circle_cen.gif" alt="circle_cen" style="WIDTH:45%;" />

#### 2 point mode

Or use `2 point` mode, define 2 points as the diameter of the circle

<img src="/media/Introduction of Rhinoceros/circle_2P.gif" alt="circle_2P" style="WIDTH:45%;" />
...
<img src="/media/Introduction of Rhinoceros/trim.gif" alt="trim" style="width:45%;" />
