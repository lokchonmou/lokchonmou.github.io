...
<img src="/media/Advance 3D drawing/fusion51.png" alt="fusion51" />
...
<img src="/media/Advance 3D drawing/image-20220530161248922.png" alt="image-20220530161248922" style="zoom:50%;" />

2. 對稱擠出65mm

<img src="/media/Advance 3D drawing/image-20220530161317601.png" alt="image-20220530161317601" style="zoom:50%;" />

3. 用`Plane at angle`建立一個30度的面

<img src="/media/Advance 3D drawing/fdahgjk.gif" alt="fdahgjk" style="zoom:50%;" />

4. 在這個面建立sketch, 繪畫後就可以用extrude擠出

<img src="/media/Advance 3D drawing/image-20220530161842815.png" alt="image-20220530161842815" style="zoom:50%;" />

<img src="/media/Advance 3D drawing/fdahgjk1.gif" alt="fdahgjk1" style="zoom:50%;" />

5. 最後重新將`sketch2`顯示出來，如題目一樣，將開孔穿到最底

<img src="/media/Advance 3D drawing/ex11.gif" alt="ex11" style="zoom:50%;" />

### 練習題2

每個格的尺寸為10x10mm

<img src="/media/Advance 3D drawing/image-20220530164054092.png" alt="image-20220530164054092" style="zoom:67%;" />

1. 首先在正面建立方形和指定斜面的尺寸

<img src="/media/Advance 3D drawing/image-20220530163256134.png" alt="image-20220530163256134" style="zoom:50%;" />

2. 整個方形連同斜面擠出40

<img src="/media/Advance 3D drawing/image-20220530163311299.png" alt="image-20220530163311299" style="zoom:50%;" />

3. 在側面建立sketch, 指定另外斜面的尺寸

<img src="/media/Advance 3D drawing/image-20220530163332181.png" alt="image-20220530163332181" style="zoom:50%;" />

4. 將兩個sketch都顯示出來(如果它自動隱藏了的話), 用`plane thought 3 points`

<img src="/media/Advance 3D drawing/fdahgjk2.gif" alt="fdahgjk2" style="zoom:50%;" />

5. 用`split body`指令將方形切開, 之後就可以將平面和不要的角隱藏

<img src="/media/Advance 3D drawing/fdahgjk3.gif" alt="fdahgjk3" style="zoom:50%;" />
...
<img src="/media/Advance 3D drawing/image-20220601102151547.png" alt="image-20220601102151547" style="zoom:80%; border: 3px solid #ccc;" />
...
<img src="/media/Advance 3D drawing/image-20220601103016049.png" alt="image-20220601103016049" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220601103051915.png" alt="image-20220601103051915" style="width:45%;" />
...
<img src="/media/Advance 3D drawing/image-20220601103301111.png" alt="image-20220601103301111" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220601103343233.png" alt="image-20220601103343233" style="width:45%;" />
...
<img src="/media/Advance 3D drawing/fdahgjk4.gif" alt="fdahgjk4" style="width:45%;" /><img src="/media/Advance 3D drawing/fdahgjk5.gif" alt="fdahgjk5" style="width:45%;" />
...
<img src="/media/Advance 3D drawing/image-20220601175838025.png" alt="image-20220601175838025" style="zoom:50%;" />
...
<img src="/media/Advance 3D drawing/fusion55.gif" alt="fusion55" style="zoom:33%;" />
...
<img src="/media/Advance 3D drawing/image-20220602120115590.png" alt="image-20220602120115590" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220602120128374.png" alt="image-20220602120128374" style="width:45%;" />
...
<img src="/media/Advance 3D drawing/fusion58.gif" alt="fusion58" style="zoom:33%;" />
...
<img src="/media/Advance 3D drawing/image-20220602123652258.png" alt="image-20220602123652258" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220602123704727.png" alt="image-20220602123704727" style="width:45%;" />
...
<img src="/media/Advance 3D drawing/image-20220602123842630.png" alt="image-20220602123842630" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220602123944252.png" alt="image-20220602123944252" style="width:45%;" />



4. 用`loft`功能, 點選剛劃的圓和圓柱的頂部, `guide type`選擇不需要`Rails`

<img src="/media/Advance 3D drawing/image-20220602123453774.png" alt="image-20220602123453774" style="zoom:45%;" />



5. 將170mm直徑的圓擠出40mm, 之後就可以用`mirror`功能, 選擇剛剛的兩個`features`做鏡像

<img src="/media/Advance 3D drawing/image-20220602134316999.png" alt="image-20220602134316999" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220602134343597.png" alt="image-20220602134343597" style="width:45%;" />
...
<img src="/media/Advance 3D drawing/fusion511.gif" alt="fusion511" style="zoom:33%;" />
...
<img src="/media/Advance 3D drawing/image-20220606112340758.png" alt="image-20220606112340758" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220606112408298.png" alt="image-20220606112408298" style="width:45%;" />



5. 用`chamfer`工具, 選擇圓的4邊修倒角0.5mm

<img src="/media/Advance 3D drawing/image-20220606112730659.png" alt="image-20220606112730659" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220606112742341.png" alt="image-20220606112742341" style="width:45%;" />
...
<img src="/media/Advance 3D drawing/image-20220606112915853.png" alt="image-20220606112915853" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220606112954437.png" alt="image-20220606112954437" style="width:45%;" />



8. 最後就可以利用`circular pattern`工具, 將球體旋轉複製30份

<img src="/media/Advance 3D drawing/image-20220606113233036.png" alt="image-20220606113233036" style="zoom:50%;" />
...
<img src="/media/Advance 3D drawing/image-20220606115238379.png" alt="image-20220606115238379" style="zoom: 50%;" />



2. 在yz平面上建立`new sketch`, 跟據圖則, 劃管的外直徑, 即Ø25的圓

<img src="/media/Advance 3D drawing/image-20220606115320815.png" alt="image-20220606115320815" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220606115635556.png" alt="image-20220606115635556" style="width:45%;" />



3. 用`sweep`指令, 用圓形作為`Profile`, 用管的中心線為`Path`, 建立管的實體

<img src="/media/Advance 3D drawing/image-20220606115456955.png" alt="image-20220606115456955" style="zoom:50%;" />



4. 用`shell`指令, 點選管的兩頭, 建立2.5mm厚度的管殼

<img src="/media/Advance 3D drawing/image-20220606115738958.png" alt="image-20220606115738958" style="zoom:50%;" />



5. 在管的末端, 建立new sketch, 跟據圖則所示劃出接法蘭的尺寸Ø45的圓, 用hotkey `E`擠出7.5mm

<img src="/media/Advance 3D drawing/image-20220606115901801.png" alt="image-20220606115901801" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220606120041439.png" style="width:45%;" />
...
<img src="/media/Advance 3D drawing/image-20220606120228464.png" alt="image-20220606120228464" style="width:45%;" /><img src="/media/Advance 3D drawing/image-20220606120257088.png" alt="image-20220606120257088" style="width:45%;" />
