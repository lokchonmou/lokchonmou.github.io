...
<img src="/media/🕒%20時間從哪裡來？——ESP32%20×%20NTP%20×%20Wi-Fi%20對時實驗/rtc-modul-ds1307-en-rtc-real-time-clock-modules-tzt-34636-51-B.jpg" alt="RTC Module - DS1307 Buy With Affordable Price - Direnc.net®" style="width:45%;" /><img src="/media/🕒%20時間從哪裡來？——ESP32%20×%20NTP%20×%20Wi-Fi%20對時實驗/RTC-DS32321-Module.png" alt="Arduino DS3231 Real Time Clock (RTC): Time and Alarms | Random Nerd  Tutorials" style="width:45%;" />
...
[人類計時技術的偉大征途：從精工機械計時到光晶格量子極限](<./人類計時技術的偉大征途：從精工機械計時到光晶格量子極限.md>)

[(簡略版)時間的追逐](/interactive/time-journey/)

## 十、工具

<a href="/media/Computational Thinking × Vibe Coding/Computational Thinking × Vibe Coding worksheet.docx" download>工作紙</a>

[反思表](</media/Computational Thinking × Vibe Coding/AI 協作編程反思與自檢表.pdf>)
