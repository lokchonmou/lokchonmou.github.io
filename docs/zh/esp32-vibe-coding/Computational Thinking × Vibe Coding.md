...
1. <a href="/media/Computational Thinking × Vibe Coding/Computational Thinking × Vibe Coding worksheet.docx" download>Computational Thinking × Vibe Coding worksheet (電子填寫和提交)</a>

2. [🧮 AI 協作編程評分量表（Vibe Coding × 運算思維整合）](</media/Computational Thinking × Vibe Coding/🧮 AI 協作編程評分量表（Vibe Coding × 運算思維整合）.pdf>)  

3. [AI 協作編程反思與自檢表(實體填寫提交)](</media/Computational Thinking × Vibe Coding/AI 協作編程反思與自檢表.pdf>) 
