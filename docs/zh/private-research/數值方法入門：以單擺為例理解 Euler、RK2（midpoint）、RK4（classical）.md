...
<img src="/media/數值方法入門/pendulum_comparison.png" alt="pendulum_comparison" style="width:80%;" />
...
- 下載模組：<a href="/media/數值方法入門/ode_integrators.py" download><strong>ode_integrators.py</strong></a>
