...
| 任務主題                                          | 說明                                                         |
| ------------------------------------------------- | ------------------------------------------------------------ |
| **ESP32 呼吸燈：用 AI 讓燈光有生命**              | 學生要寫出控制 LED 呼吸節奏的完整 PRD，理解 I/O、限制、驗收條件。 |
| **AI 資訊搜尋助手：「AI 教育趨勢 2025」最新資料** | 學生要寫出明確的資訊查詢任務，定義輸入關鍵字、輸出格式、真偽檢核標準。 |
| **文章生成器：「AI 與創意思維」報告草稿**         | 學生要指定主題、字數、語氣、結構，練習量化要求與檢查條件。   |
| **程式生成：計算平均值與標準差**                  | 學生要定義輸入格式、輸出精度、錯誤處理與允許使用的標準庫。   |
